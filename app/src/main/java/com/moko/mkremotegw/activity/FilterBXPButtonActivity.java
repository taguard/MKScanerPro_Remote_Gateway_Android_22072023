...
import com.moko.mkremotegw.databinding.ActivityFilterBxpButtonBinding;
...
public class FilterBXPButtonActivity extends BaseActivity<ActivityFilterBxpButtonBinding> {
    ...
    @Override
    protected ActivityFilterBxpButtonBinding getViewBinding() {
        return ActivityFilterBxpButtonBinding.inflate(getLayoutInflater());
    }
